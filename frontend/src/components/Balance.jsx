...
export const Balance = ({ value,sent,received,added }) => {
    return <div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 px-12 my-8">
      ...
      <div className="p-5 rounded-lg text-white bg-blue-500">
        <div className="font-semibold text-2xl">Money Added</div>
        <div className="font-medium text-4xl">₹{Math.floor(added)}</div>
      </div>
    </div>
    </div>
}
